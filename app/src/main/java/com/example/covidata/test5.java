...
int a,b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("assesment").child("muscleaches");
    ...
    public void loadTest(View view) {
        switch (view.getId()) {
            ...
            case R.id.button2:
                ...
                cnt = cnt + 0;
                Intent intent1 = new Intent(getApplicationContext(), test6.class);
